...
def upload_file():
    ...
    with graph.as_default():
        if request.method == 'POST':
                ...
                pred_answer1="ラベル:"+str(array_class[0])+ ",確率："+str(percentage[0])+"%"
                pred_answer2="ラベル:"+str(array_class[1])+ ",確率："+str(percentage[1])+"%"
                pred_answer3="ラベル:"+str(array_class[2])+ ",確率："+str(percentage[2])+"%"
                ...
                return render_template("index.html",answer1=pred_answer1,img_data1=img_src1,answer2=pred_answer2,img_data2=img_src2)
